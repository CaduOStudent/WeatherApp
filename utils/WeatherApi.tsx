...
export async function getWeatherData(latitude: number, longitude: number): Promise<WeatherData> {
    const params = {
        ...
        longitude: [longitude],
        daily: [
            "sunrise", "sunset", "daylight_duration", "rain_sum", "showers_sum", "snowfall_sum"
        ],
        hourly: [
            "temperature_2m", "weather_code", "cloud_cover", "precipitation", "wind_speed_10m", "uv_index"
        ],
        current: [
            "weather_code", "precipitation", "is_day", "apparent_temperature", "temperature_2m", "wind_speed_10m", "wind_direction_10m", "wind_gusts_10m", "cloud_cover"
        ],
        minutely_15: [
            "temperature_2m", "precipitation", "is_day", "wind_speed_80m", "apparent_temperature"
        ],
        timezone: "auto",
        forecast_hours: 1,
