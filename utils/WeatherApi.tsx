...
// Interface describing the structure of weather data returned by the API
...
// Main function to fetch weather data from Open-Meteo API for a given latitude and longitude
export async function getWeatherData(latitude: number, longitude: number): Promise<WeatherData> {
    ...
    // Helper to build time arrays for each data block
